...
export const Borracha=()=>{
    const cor = "ghostwhite";
    const btnBorracha=document.querySelector('.borracha')
    btnBorracha.addEventListener('click',event=>{
